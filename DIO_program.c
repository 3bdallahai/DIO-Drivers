...
switch (copy_uint8_port)
	{
		case DIO_UINT8_PORTA: DDRA = copy_uint8_value; break;
		case DIO_UINT8_PORTB: DDRB = copy_uint8_value; break;
		case DIO_UINT8_PORTC: DDRC = copy_uint8_value; break;
		case DIO_UINT8_PORTD: DDRD = copy_uint8_value; break;
	}
